...
public class DetailPraiseFragment extends BaseFragment {
    public DetailPraiseFragment(Context context){
        mContext = context;
    }
    ...
    protected View initView() {
        mView = View.inflate(mContext, R.layout.fragment_home_detail_praise,null);
        return mView;
    }
